...
*/
if(!isomorphicDir){var isomorphicDir = 'showcase/sc/';}
...
return this.$s4()}
);isc.evalBoundary;isc.B.push(isc.A.$s4=function isc_Canvas__getLeftOffsetFromElement(_1){if(_1==null)_1=this.getDocumentBody();var _2=this.ns.Element.$s4(this.getClipHandle(),_1,this.isRTL());if(this.getScrollingMechanism()==isc.Canvas.CLIP)_2+=this.scrollLeft;return _2}
...
return this.$s5()}
,isc.A.$s5=function isc_Canvas__getTopOffsetFromElement(_1){if(_1==null)_1=this.getDocumentBody();var _2=this.ns.Element.$s5(this.getClipHandle(),_1);if(this.getScrollingMechanism()==isc.Canvas.CLIP)_2+=this.scrollTop;return _2}
...
);isc.evalBoundary;isc.B.push(isc.A.$414=function isc_Canvas__relativePageResized(){if(!this.isDrawn()||this.parentElement||this.position!=this.$411)return;var _1=this.$412,_2=this.$413,_3=this.getPageLeft(),_4=this.getPageTop();this.$tx=(_3-_1);this.$ty=(_4-_2);this.$t2();this.$412=_3;this.$413=_4;isc.Page.setEvent("resize",this,isc.Page.FIRE_ONCE,"$414")}
...
);isc.evalBoundary;isc.B.push(isc.A.setShowShadow=function isc_Canvas_setShowShadow(_1){this.showShadow=_1;if(_1){if(!this._shadow)this.$pr();else if(this.isDrawn())this._shadow.show()}else{if(this._shadow)this._shadow.hide()}}
