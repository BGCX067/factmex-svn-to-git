...
import mx.com.factmex.app.client.data.CommandTreeNode;
import mx.com.factmex.app.client.data.ExplorerTreeNode;
import mx.com.factmex.app.client.to.request.Request;
import mx.com.factmex.app.client.to.response.Response;
import mx.com.factmex.app.client.window.LoginWindow;
...
implements EntryPoint, HistoryListener {
    ...
    public void onModuleLoad() {
        ...
        Label title = new Label("Facturacion Electronica (MX)");
        ...
        devConsoleButton.setTitle("Cerrar Sesion");
        devConsoleButton.setIcon("silk/world.png");
