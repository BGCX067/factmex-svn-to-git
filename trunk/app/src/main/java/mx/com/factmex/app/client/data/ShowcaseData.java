...
import mx.com.factmex.app.client.form.factura.FacturasRecibidasForm;
import mx.com.factmex.app.client.form.factura.ListClientesForm;
import mx.com.factmex.app.client.form.factura.ListSeriesForm;
import mx.com.factmex.app.client.form.factura.NuevaFacturaForm;
import mx.com.factmex.app.client.form.factura.ReporteMensualForm;
import mx.com.factmex.app.client.miniapp.MiniAppSample;
    ...
    private ExplorerTreeNode[] getData() {
        if (data == null) {
            data = new ExplorerTreeNode[]{
                    ...
                    new ExplorerTreeNode("Mis Facturas", "featured-category", "root", "silk/application_view_detail.png", null, true, idSuffix),
                    new ExplorerTreeNode("Nueva Factura", "nueva-factura", "featured-category", "silk/new.png", new NuevaFacturaForm.Factory(), true, idSuffix),
                    new ExplorerTreeNode("Generadas", "facturas-enviadas", "featured-category", "silk/arrow_join.png", new FacturasEnviadasForm.Factory(), true, idSuffix),
                    new ExplorerTreeNode("Recibidas", "facturas-recibidas", "featured-category", "silk/arrow_refresh_small.png", new FacturasRecibidasForm.Factory(), true, idSuffix),
                    new ExplorerTreeNode("Reporte Mensual", "reporteMensual", "featured-category", "silk/chart_bar.png", new ReporteMensualForm.Factory(), true, idSuffix),
                    new ExplorerTreeNode("Administracion", "admon-category", "root", "silk/layout_content.png", null, true, idSuffix),
                    //new ExplorerTreeNode("Emisores", "emisores", "admon-category", "icons/16/person_drop.png", new NuevaFacturaForm.Factory(), false, idSuffix),
                    new ExplorerTreeNode("Clientes", "clientes", "admon-category", "icons/16/person.png", new ListClientesForm.Factory(), true, idSuffix),
                    //new ExplorerTreeNode("Usuarios", "usuarios", "admon-category", "pieces/16/pawn_blue.png", new NuevaFacturaForm.Factory(), false, idSuffix),
                    new ExplorerTreeNode("Series", "series", "admon-category", "silk/timeline_marker.png", new ListSeriesForm.Factory(), true, idSuffix),
                    new ExplorerTreeNode("Configuracion", "configuracion", "admon-category", "pieces/16/cube_frame.png", new NuevaFacturaForm.Factory(), false, idSuffix),
                    /*
                    ...
                    new ExplorerTreeNode("Yahoo! XML Services", "yahoo-xml-integration-category", "xml-integration-category", null, new YahooXmlServicesSample.Factory(), true, idSuffix),
